...
test('renders KO LDA summary and chart payload', () => {
  render(<KoLdaBarChart data={ldaData} />);

  expect(document.body.textContent).toContain('P < 0.05');
  expect(document.body.textContent).toContain('Top 30 KO');
...
test('builds a horizontal bar chart with AD and NC colors', () => {
  render(<KoLdaBarChart data={ldaData} />);
